...
//            .addClass('open');
	    	if (input) {
	    		$(".xy-dialog-s .su").text(input);
	    	}
	    	$( ".xy-dialog-s").css("left" , ($(window).width() - 160)/2 + "px" );
	    	$( ".xy-dialog-s").css("top" , ($(window).height() - $(".xy-dialog-s" ).height())/2 - 80 + "px");
	    	$( ".xy-dialog-s").show(300);
	    	setTimeout("$('.xy-dialog-s').fadeOut()",2800);
          ...
          case 'loading':
            ...
            angular
              ...
              .attr('src', input.image || 'lib/angular-modal-alerts-0.0.15/lib/assets/img/loader1.gif');
